...
<p class="titulo">ELIMINAR USUARIOS</p>
<form id="form1" name="form1" method="post" action="<?= site_url('usuarios/' . $usuario['IdUsuario'] . '/eliminar') ?>">
  <p>
  ...
  <p align="center">
    <input type="submit" name="Si" value="Eliminar"/>
